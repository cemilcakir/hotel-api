...
class RequestTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $request = Request::create('http://test.com/appartRoom-1234', 'GET', array(), array(), array(),
            array(
                'DOCUMENT_ROOT' => '/var/www/www.test.com',
                'SCRIPT_FILENAME' => '/var/www/www.test.com/app/app.php',
                'SCRIPT_NAME' => '/app/app.php',
                'PHP_SELF' => '/app/app.php/appartRoom-1234',
            ));
        $this->assertEquals('http://test.com/appartRoom-1234', $request->getUri());
        $this->assertEquals('/appartRoom-1234', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEquals('test.com', $request->getHttpHost());
        $this->assertFalse($request->isSecure());
